<template>
    <div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-wrapper">
                            <h1>Our Event</h1>
                            <span><a href="index.html">Home</a><i class="bi bi-chevron-right"></i>Our Event</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="event-area sec-mar-top">
            <div class="container">
                <div class="row justify-content-center">
                ...
                <div class="row gy-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="single-event wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <div class="event-inner">
                                ...
                                <h4><a href="event-details.html">Use what the renowned improv comedy</a></h4>
                                <div class="join-btn">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="single-event wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                            ...
                            <div class="event-inner">
                                <span><i class="fas fa-map-marker-alt"></i>1 South Ave 01, New York</span>
                                <h4><a href="event-details.html">Evaluating The Best Ways to Give to the Poor</a></h4>
                                <div class="join-btn">
                                    <a href="event-details.html">Join Event</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="single-event wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <div class="event-inner">
                                <span><i class="fas fa-map-marker-alt"></i>1 South Ave 01, New York</span>
                                <h4><a href="event-details.html">Take Your Online Donation to the Next Level!</a></h4>
                                <div class="join-btn">
                                    <a href="event-details.html">Join Event</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="single-event wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                            ...
                            <div class="event-inner">
                                <span><i class="fas fa-map-marker-alt"></i>1 South Ave 01, New York</span>
                                <h4><a href="event-details.html">This is a great tactic for event name to us</a></h4>
                                <div class="join-btn">
                                    <a href="event-details.html">Join Event</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="single-event wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            ...
                            <div class="event-inner">
                                <span><i class="fas fa-map-marker-alt"></i>1 South Ave 01, New York</span>
                                <h4><a href="event-details.html">Being on the nose is not such a bad thing</a></h4>
                                <div class="join-btn">
                                    <a href="event-details.html">Join Event</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="footer-widget">
                                <div class="info">
                                    ...
                                    <div class="email">
                                        <a href="/cdn-cgi/l/email-protection#0f666169604f6a776e627f636a216c6062"><span
                                                class="__cf_email__"
                                                data-cfemail="f69f989099b6938e979b869a93d895999b">[email&#160;protected]</span></a>
                                        <a href="/cdn-cgi/l/email-protection#ef9c9a9f9f809d9bafad8a96818bc18c8082"><span
                                                class="__cf_email__"
                                                data-cfemail="dba8aeababb4a9af9bbea3bab6abb7bef5b8b4b6">[email&#160;protected]</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
